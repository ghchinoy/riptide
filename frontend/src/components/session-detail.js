          ...
          ${this.session.turns?.map((t) => html `
            <div class="turn-card">
              ...
              <div class="turn-content">
                <div class="reasoning">
                  ${t.thinking?.map((thought) => html `<p class="thought">${thought}</p>`)}
                </div>
                <div class="visuals">
                  ...
                  <div class="screenshot-container">
                    <img src="${this.apiBase}/screenshots/${t.full_page}" alt="Full page screenshot" @error=${(e) => e.target.style.display = 'none'}>
...
], SessionDetail.prototype, "location", void 0);
__decorate([
    state(),
    __metadata("design:type", Object)
], SessionDetail.prototype, "session", void 0);
__decorate([
    state(),
    __metadata("design:type", Object)
